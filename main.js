...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {S: fragment, T: host, aw: path, Y: port_, aa: protocol, ab: query};
	});
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														elm$html$Html$text('Elm Navigation')
													]))
											]))
									]))
							]))
								...
								switch (_n0) {
									case '/home':
										return A2(
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('/img/home.png')
												]),
											_List_Nil);
									case '/profile':
										return A2(
											...
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('/img/jikosyoukai_man.png')
												]),
											_List_Nil);
									case '/reviews/the-century-of-the-self':
										return A2(
											elm$html$Html$img,
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('/img/einstein.png')
												]),
											_List_Nil);
									case '/reviews/public-opinion':
										return A2(
											elm$html$Html$img,
											_List_fromArray(
												[
													elm$html$Html$Attributes$src('/img/public_viewing.png')
												]),
											_List_Nil);
									default:
...
var author$project$Main$main = elm$browser$Browser$application(
	{ar: author$project$Main$init, at: author$project$Main$UrlChanged, au: author$project$Main$LinkClicked, ay: author$project$Main$subscriptions, aA: author$project$Main$update, aB: author$project$Main$view});
